...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two Strings as arguments, and sets the name of this Silly instance to
     * the concatenation of the first string + the second string.
     *
     * @param s1 first input String for Silly instance's name.
     * @param s2 second input String for Silly instance's name.
     */
